...
================================================== -->
				...
				<?php if ( is_page_template( 'page-portfolio.php' ) ) { ?>
					...
					<?php if ( ! empty( $portfolio_filtering ) ) : ?>
						...
						<?php $wp_list_categories = wp_list_categories( array( 'title_li' => '', 'show_option_none' => '', 'taxonomy' => 'category', 'walker' => new Walker_Portfolio_Category(), 'orderby' => 'name', 'style' => 'none', 'echo' => 0 ) ); ?>
				...
				<?php } else if ( is_page_template( 'page-galleries-list.php' ) ) { ?>
					...
					<?php $gallery_filtering = ot_get_option( 'gallery_filtering' ); ?>
						...
						<pre style="display: none;">
							<?php print_r($wp_list_categories); ?>
						</pre>
